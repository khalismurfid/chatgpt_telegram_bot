...
class ChatGPT:
    def __init__(self, model="gpt-4o-mini"):
        assert model in {"gpt-4o-mini","text-davinci-003", "gpt-3.5-turbo-16k", "gpt-3.5-turbo", "gpt-4", "gpt-4o", "gpt-4-1106-preview", "gpt-4-vision-preview"}, f"Unknown model: {model}"
        self.model = model
    ...
    async def send_message(self, message, dialog_messages=[], chat_mode="assistant"):
        ...
        while answer is None:
            try:
                if self.model in {"gpt-4o-mini", "gpt-3.5-turbo-16k", "gpt-3.5-turbo", "gpt-4", "gpt-4o", "gpt-4-1106-preview", "gpt-4-vision-preview"}:
    ...
    async def send_message_stream(self, message, dialog_messages=[], chat_mode="assistant"):
        ...
        while answer is None:
            try:
                if self.model in {"gpt-4o-mini", "gpt-3.5-turbo-16k", "gpt-3.5-turbo", "gpt-4","gpt-4o", "gpt-4-1106-preview"}:
                    messages = self._generate_prompt_messages(message, dialog_messages, chat_mode)
    ...
    async def send_vision_message(
        ...
        while answer is None:
            try:
                if self.model == "gpt-4o-mini" or self.model == "gpt-4-vision-preview" or self.model == "gpt-4o":
    ...
    async def send_vision_message_stream(
        ...
        while answer is None:
            try:
                if self.model == "gpt-4o-mini" or self.model == "gpt-4-vision-preview" or self.model == "gpt-4o" or self.model == "gpt-4o-mini":
                    messages = self._generate_prompt_messages(
                        message, dialog_messages, chat_mode, image_buffer
                    )
