...
async def _vision_message_handle_fn(
    ...
    if current_model != "gpt-4-vision-preview" and current_model != "gpt-4o" and current_model != "gpt-4o-mini":
        await update.message.reply_text(
            "🥲 Images processing is only available for <b>gpt-4-vision-preview</b>, <b>gpt-4o-mini</b>, and <b>gpt-4o</b> model. Please change your settings in /settings",
...
async def message_handle(update: Update, context: CallbackContext, message=None, use_new_dialog_timeout=True):
    ...
    async with user_semaphores[user_id]:
        if current_model == "gpt-4-vision-preview" or current_model == "gpt-4o" or current_model == "gpt-4o-mini" or update.message.photo is not None and len(update.message.photo) > 0:

            logger.error(current_model)
            # What is this? ^^^

            if current_model != "gpt-4o" and current_model != "gpt-4-vision-preview" and current_model != "gpt-4o-mini":
